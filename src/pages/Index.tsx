    ...
    <main className="h-[100dvh] flex flex-col overflow-hidden">
      ...
      >
        <div className="flex flex-col items-center text-center max-w-md w-full">
          ...
          >
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-black gradient-text">Rules Mate</h1>
            <p className="text-sm sm:text-base text-muted-foreground">Board game help, instantly.</p>
          </motion.div>
          ...
          <motion.input 
            ...
            className="w-full max-w-xs sm:max-w-sm bg-card border border-border rounded-xl px-4 py-3 text-base text-foreground placeholder:text-muted-foreground text-center mb-6 focus:outline-none focus:ring-2 focus:ring-accent-start/50 focus:border-accent-start/50 transition-all"
          />
          ...
          <motion.div 
            ...
            className="grid grid-cols-2 gap-2 sm:gap-3 w-full max-w-xs sm:max-w-sm mb-6"
          >
            {shortcuts.map((shortcut, index) => {
              ...
              return (
                <motion.button 
                  ...
                  className={`flex flex-col items-center gap-1.5 p-3 sm:p-4 bg-card/30 border rounded-xl transition-all ${
                    isSelected 
                ...
                >
                  <div className={`w-8 h-8 sm:w-10 sm:h-10 rounded-lg flex items-center justify-center transition-colors ${
                    ...
                    <Icon className={`w-4 h-4 sm:w-5 sm:h-5 ${isSelected ? "text-accent-end" : "text-accent-start"}`} />
                  </div>
                  <span className="text-xs sm:text-sm font-medium text-foreground">{shortcut.label}</span>
          ...
          <motion.button 
            ...
            className="gradient-accent px-10 sm:px-12 py-3 rounded-full text-foreground font-bold shadow-glow disabled:opacity-50 disabled:cursor-not-allowed transition-all"
          >
            Start
          </motion.button>
        </div>
