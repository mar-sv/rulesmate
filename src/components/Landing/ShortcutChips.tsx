      ...
      {shortcuts.map((shortcut, index) => {
        ...
        return (
          <motion.button
            ...
            className="group relative rounded-full border border-accent-start/40 px-6 py-3 text-foreground font-medium transition-all hover:border-accent-end/60 overflow-hidden"
          >
